...
function neuf_eventtype_custom_box(){
  ...
  $neuf_event_type = get_post_meta($post->ID, 'neuf_event_type');

  echo "Type:";
  echo '<select name="neuf_event_type">';
  $types = array(
...
function neuf_eventvenue_custom_box(){
  ...
  $neuf_event_venue = get_post_meta($post->ID, 'neuf_events_venue');
...
function neuf_event_div_custom_box(){
  ...
  $neuf_event_price = get_post_meta($post->ID, 'neuf_events_price');
  $neuf_event_bs = get_post_meta($post->ID, 'neuf_events_bs_url');
  $neuf_event_fb = get_post_meta($post->ID, 'neuf_events_fb_url');

  echo '<h4>Andre detaljer</h4>';
  echo '<br />Pris:<br /><input name="neuf_events_price" value="Gratis" />';
  echo '<br />Billettservice url:<br /><input name="neuf_events_bs_url" value="" />';
  echo '<br />Facebook url:<br /><input name="neuf_events_fb_url" value="" />';
...
function neuf_events_save_info( $post_id ) {
  ...
  $neuf_event_venue = $_POST['neuf_events_venue'];
  $neuf_event_type = $_POST['neuf_events_type'];
  $neuf_event_price = $_POST['neuf_events_price'];
  $neuf_event_bs_url = $_POST['neuf_events_bs_url'];
  $neuf_event_fb_url = $_POST['neuf_events_fb_url'];
  ...
  $quicksave = array('events_price','events_bs_url','events_fb_url','events_type', 'events_venue');
